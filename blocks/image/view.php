...
if (is_object($f) && $f->getFileID()) {
    ...
    $imageWidth = (int) $f->getAttribute('width');
    $imageHeight = (int) $f->getAttribute('height');
    ...
    // Add sizing for main image
    if ($imageWidth || $imageHeight) {
        $imageTag->setAttribute('width', "{$imageWidth}px");
        $imageTag->setAttribute('height', "{$imageHeight}px");
    }
