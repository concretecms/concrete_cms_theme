...
class AssetsLocalization extends Controller
{
    ...
    public function getCommunityJavascript(): Response
    {
        ...
        $content = 'var ccmi18n_community = ' . json_encode([
                ...
                "uploadFilesNotice" => t("Files no larger than %s.", ini_get('upload_max_filesize')),
                "uploadFileTooLargeNotice" => t('Uploaded file is too large. The current value of upload_max_filesize is %s', ini_get('upload_max_filesize')),
