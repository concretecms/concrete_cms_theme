        ...
        <?php if ($includeEntryText): ?>
            <div class="ccm-block-page-list-page-entry-text">
                ...
                <div class="ccm-block-page-list-description">
                    <?php
                    $descriptionArea = new Area('Main');
                    $descriptionArea->disableControls();
                    ob_start();
                    $descriptionArea->display($page);
                ...
                if ($moreArea->getTotalBlocksInArea($page)) {?>
                    <div class="ccm-block-page-list-read-more">
                        <a href="<?=$page->getCollectionLink()?>" class="btn btn-secondary">Read Full Post</a>
                    </div>
                <?php } ?>
